	...
	<div class="col-12" style="background-color: whitesmoke;">
		<div class="board-header" style="padding: 10px;">
			<h5 style="display: inline;">
				<input id="board-idx" value="${boardContent.idx}" style="display: none;">
				<b>Modify</b>
			</h5>
		</div>
		...
		<div class="board-body" style="padding: 10px;">
			<img alt="" src="/images/user2.png" style="margin-bottom: 10px;"
				width="35px;">
			<h3 style="display: inline;">${boardContent.creation_userid}</h3>
			...
			<textarea class="col-12" id="board-textarea"
				style="height: 500px; resize: none; border: solid #C1C1C1 1px; padding: 15px;">${boardContent.contents}</textarea>
