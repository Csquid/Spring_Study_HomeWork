        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse justify-content-start ml-md-auto " id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" id="parallax" href="/parallax">parallax</a>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse justify-content-end ml-md-auto" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <div class="navar-nav">
                        <a class="nav-item nav-link" id="button_login" data-toggle="modal" data-target="#modal_login"
                            style="align: right; display: none" href="#">Login</a>
                        <a class="nav-item nav-link" id="button_logout" onclick="location.href='/user/logout'"
